...
sealed class CalDisResource<T>(val data: T? = null, val message: String? = null, val error: Throwable? = null, val exceptionTypeEnum: ExceptionTypeEnum? = null) {
    ...
    class Error<T>(message: String? = null, error: Throwable? = null, exceptionTypeEnum: ExceptionTypeEnum? = null,data: T? = null) : CalDisResource<T>(data, message, error, exceptionTypeEnum)
